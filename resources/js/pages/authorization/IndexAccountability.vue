<template>
    ...
    <Layout>
        <div class="q-px-sm q-py-md">
            ...
            <q-card class="card-form q-mt-md">
                <q-table :loading="table.loading" :rows="authorized" :columns="table.columns" row-key="id" class="table-theme"
                    :filter="table.filter_authorized" separator="horizontal" :grid="grid" flat bordered
                    :table-header-class="{ 'table-header-theme': true }">
                    <template v-slot:top>
                        <h5 class="title-form">Lista de Rendiciones a Autorizadas</h5>
                        <q-space />
                        <q-input outlined dense color="primary" placeholder="Buscar..." v-model="table.filter_authorized"
                            class="input-theme">
                            <template v-slot:append>
                                <q-icon name="search" />
                            </template>
...
let authorized = ref(page.props.authorized);

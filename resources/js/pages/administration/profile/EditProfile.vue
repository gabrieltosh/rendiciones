        ...
        <div class="row justify-center q-px-md q-py-lg">
            <div class="col-xs-12 col-sm-12 col-md-11">
                <q-stepper v-model="step" header-nav ref="stepper" color="primary" animated flat alternative-labels
                    ...
                    <q-step class="backgroup-theme" :name="1" title="Formulario de Perfil" icon="settings"
                        :done="step > 1" :error="Object.keys(errors).length > 0 ? true : false">
                        ...
                        <q-card class="q-pa-lg q-ma-sm card-form">
                            ...
                            <div class="row q-mt-xs q-pa-sm q-mt-sm">
                                <div class="col-12 q-mb-md" v-for="(item, index) in form.documents" :key="index">
                                    <q-markup-table separator="cell" flat bordered dense :class="{
                                        delete: item.for_delete == 1,
                                    ...
                                    <q-markup-table separator="cell" flat bordered dense>
                                        ...
                                        <tbody>
                                            <tr v-for="(
                                                ...
                                                ) in item.detail" :key="index_proration" :class="{
                                                    'bg-negative':
                                                    proration.for_delete == 1,
                                                }">
                                    ...
                                    <q-markup-table separator="cell" flat bordered dense>
                                        ...
                                        <tbody>
                                            <tr v-for="(
                                                    field, index_field
                                                ) in item.fields" :key="index_field" :class="{
                                                    'bg-negative':
                                                    field.for_delete == 1,
                                                }">
                                                <td class="text-center">
...
function HandleDeleteLineField(index, index2) {
    $q.dialog({
        ...
        .onOk(() => {
            if (form.value.documents[index].fields[index2].id) {
                form.value.documents[index].fields[index2].for_delete = 1;
            } else {
...
.delete-line td {
    ...
    /* Establece un borde de 1px sólido en todas las celdas */
